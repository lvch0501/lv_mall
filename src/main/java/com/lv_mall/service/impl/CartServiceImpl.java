        ...
        if(CollectionUtils.isNotEmpty(cartlist)){
            for (Cart cartItem : cartlist){
                ...
                if(product!=null){
                    ...
                    cartProductVo.setPruductSubtitle(product.getSubtitle());
